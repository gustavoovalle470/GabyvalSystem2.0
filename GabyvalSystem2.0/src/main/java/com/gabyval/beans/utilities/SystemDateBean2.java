 ...
 * @since 26/08/2017
 */
//@Named(value = "SystemDateBean2")
//@SessionScoped
@ManagedBean(name = "SystemDateBean2")
@ViewScoped
public class SystemDateBean2 implements Serializable{

    private static final GB_Logger LOG = GB_Logger.getLogger(SystemDateBean2.class);
    private String paused;
    private HashMap<String, Integer> systemState;

    public SystemDateBean2() {
